					...
					<div className="pos-content">
						<div className="pos-content-container p-4">
							<div className="d-md-flex align-items-center mb-4">
								...
								<div>
									<div className="w-200px mb-0">
										<input type="date" className="form-control" placeholder="Today's" />
									</div>
								</div>
							</div>
							<div className="row gx-4">
								{tableData && tableData.length > 0 ? (tableData.map((table, index) => (
									<div className="col-xl-2 col-lg-3 col-md-4 col-sm-6" key={index}>
										<div className="pos-table-booking position-relative">
												...
												<div className="pos-table-booking-header">
													<div className="d-flex align-items-center">
														...
														{!checkAvailable(table.reservation) ? (
															<div className="pe-1 text-theme">
																<i className="far fa-check-circle fa-3x"></i>
															</div>
														) : (
															<div className="text-body text-opacity-25">
																<i className="far fa-check-circle fa-3x"></i>
															</div>
														)}
													</div>
						...
						<div className="p-0">
							<div className="modal-header align-items-center">
								<h5 className="modal-title d-flex align-items-end">
									Table 01 
									<small className="fs-14px ms-2 text-body text-opacity-50">max 4 pax</small>
								</h5>
							...
							<div className="modal-body">
								<div className="row">
									<div className="col-lg-6">
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">08:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">09:00am</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Sean" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">10:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">11:00am</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">12:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">01:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">02:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">03:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
									</div>
									<div className="col-lg-6">
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">04:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">05:00pm</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Irene Wong (4pax)" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">06:00pm</div>
												<input type="text" className="form-control" placeholder="" defaultValue="Reserved by Irene Wong (4pax)" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">07:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">08:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">09:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
										<div className="form-group mb-2">
											<div className="input-group">
												<div className="input-group-text fw-semibold w-90px fs-13px">10:00pm</div>
												<input type="text" className="form-control" placeholder="" />
											</div>
										</div>
									</div>
							...
							<div className="modal-footer">
								...
								<button type="submit" className="btn btn-theme w-100px">Book</button>
							</div>
						</div>
					</div>
				</div>
