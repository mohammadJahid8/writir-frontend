					...
					<div className="pos-sidebar" id="pos-sidebar">
						<div className="h-100 d-flex flex-column p-0">
							<div className="pos-sidebar-header">
								...
								<div className="order small">Order: {tableData && tableData.orderNo && (tableData.orderNo)}</div>
							</div>
					
							<div className="pos-sidebar-nav small">
								...
								<div className="mt-3">
									<div className="d-flex">
										<button className="btn btn-default w-70px me-10px d-flex align-items-center justify-content-center">
											<span>
												<i className="fa fa-bell fa-lg my-10px d-block"></i>
												<span className="small fw-semibold">Service</span>
											</span>
										</button>
										<button className="btn btn-default w-70px me-10px d-flex align-items-center justify-content-center">
											<span>
										...
										<button className="btn btn-theme flex-fill d-flex align-items-center justify-content-center">
											<span>
												<i className="fa fa-cash-register fa-lg my-10px d-block"></i>
												<span className="small fw-semibold">Submit Order</span>
											</span>
										</button>
									</div>
								</div>
								...
								<div className="p-0">
									...
									<div className="modal-pos-product">
										...
										<div className="modal-pos-product-info">
											...
											<div className="fs-3 fw-bold mb-3">${ modalData.price }</div>
