...
function ChartApex() {
	...
	function getMixedChartOptions() {
		...
		return {
			...
			grid: { borderColor: borderColor },
			title: { text: 'XYZ - Stock Analysis (2012 - 2021)', align: 'center', style: { fontSize: '14px', fontWeight: 'bold', fontFamily: themeFont, color: bodyColor } },
			xaxis: {
	...
	function getBubbleChartOptions() {
		...
		return {
			dataLabels: { enabled: false },
			colors: [themeColor, teal, 'rgba(' + bodyColorRgb + ', .5)', pink],
			grid: { borderColor: borderColor },
			fill: { opacity: 0.8 },
					...
					<div className="row">
						<div className="col-xl-9">
							...
							<div id="apexChartLineChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Line Chart</h6>
										<Chart type="line" height="350" options={lineChartOptions} series={lineChartData} />
									</CardBody>
							...
							<div id="apexChartColumnChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Column Chart</h6>
										<Chart type="bar" height="350" options={columnChartOptions} series={columnChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartAreaChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Area Chart</h6>
										<Chart type="area" height="350" options={areaChartOptions} series={areaChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartBarChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Bar Chart</h6>
										<Chart type="bar" height="350" options={barChartOptions} series={barChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartMixedChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Mixed Chart</h6>
										<Chart type="line" height="350" options={mixedChartOptions} series={mixedChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartCandlestickChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Candlestick Chart</h6>
										<Chart type="candlestick" height="350" options={candlestickChartOptions} series={candlestickChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartBubbleChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Bubble Chart</h6>
										<Chart type="bubble" height="350" options={bubbleChartOptions} series={bubbleChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartScatterChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Scatter Chart</h6>
										<Chart type="scatter" height="350" options={scatterChartOptions} series={scatterChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartHeatmapChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Heatmap Chart</h6>
										<Chart type="heatmap" height="350" options={heatmapChartOptions} series={heatmapChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartPieChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Pie Chart</h6>
										<Chart type="pie" height="350" options={pieChartOptions} series={pieChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartRadialBarChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Radial Bar Chart</h6>
										<Chart type="radialBar" height="350" options={radialBarChartOptions} series={radialBarChartData} />
									</CardBody>
									<div className="hljs-container">
							...
							<div id="apexChartRadarChart" className="mb-5">
								<Card>
									<CardBody>
										<h6 className="mb-3">Radar Chart</h6>
										<Chart type="radar" height="350" options={radarChartOptions} series={radarChartData} />
									</CardBody>
									<div className="hljs-container">
