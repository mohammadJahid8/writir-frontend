					...
					<div className="row">
						<div className="col-xl-9">
							...
							<div id="googleMapReact" className="mb-5">
								...
								<p>Google Map React  is a component written over a small set of the Google Maps API. It allows you to render any React component on the Google Map. Please read the <a href="https://www.npmjs.com/package/@react-google-maps/api" target="_blank" rel="noreferrer">official documentation</a> for the full list of options.</p>
								<Card>
									<CardBody>
