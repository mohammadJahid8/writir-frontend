					...
					<div className="row">
						<div className="col-xl-9">
									...
									<CardBody>
										<div className="row">
											<div className="col-lg mb-lg-0 mb-3">
												<div className="small fw-bold text-body text-opacity-50 mb-2">ADDITIVE</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border me-2 bg-body"></div> .border</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border-top me-2 bg-body"></div> .border-top</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border-end me-2 bg-body"></div> .border-end</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border-bottom me-2 bg-body"></div> .border-bottom</div>
												<div className="d-flex align-items-center mb-4"><div className="w-30px h-30px border-start me-2 bg-body"></div> .border-start</div>
												
												<div className="small fw-bold text-body text-opacity-50 mb-2">SUBTRACTIVE (REMOVE)</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border border-0 me-2 bg-body"></div> .border-0</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border border-top-0 me-2 bg-body"></div> .border-top-0</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border border-end-0 me-2 bg-body"></div> .border-end-0</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border border-bottom-0 me-2 bg-body"></div> .border-bottom-0</div>
												<div className="d-flex align-items-center mb-1"><div className="w-30px h-30px border border-start-0 me-2 bg-body"></div> .border-start-0</div>
											</div>
											<div className="col-lg">
												<div className="small fw-bold text-body text-opacity-50 mb-2">BORDER COLOR</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-primary me-1 bg-body"></div>
													<div className="w-30px h-30px border border-primary-subtle me-2 bg-body"></div> 
													.border-primary / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-secondary me-1 bg-body"></div>
													<div className="w-30px h-30px border border-secondary-subtle me-2 bg-body"></div> 
													.border-secondary / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-success me-1 bg-body"></div>
													<div className="w-30px h-30px border border-success-subtle me-2 bg-body"></div> 
													.border-success / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-danger me-1 bg-body"></div>
													<div className="w-30px h-30px border border-danger-subtle me-2 bg-body"></div>
													.border-danger / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-warning me-1 bg-body"></div>
													<div className="w-30px h-30px border border-warning-subtle me-2 bg-body"></div>
													.border-warning / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-info me-1 bg-body"></div> 
													<div className="w-30px h-30px border border-info-subtle me-2 bg-body"></div> 
													.border-info / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-light me-1 bg-body"></div> 
													<div className="w-30px h-30px border border-light-subtle me-2 bg-body"></div> 
													.border-light / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-dark me-1 bg-body"></div> 
													<div className="w-30px h-30px border border-dark-subtle me-2 bg-body"></div> 
													.border-dark / subtle
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px border border-white me-2 bg-body"></div> 
													.border-white
												</div>
											</div>
										</div>
							...
							<div id="textColor" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-lg mb-lg-0 mb-3">
												<div className="small fw-bold text-body text-opacity-50 mb-2">BOOTSTRAP TEXT COLOR</div>
												<div className="d-flex align-items-center mb-1">
												...
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px me-1 border fs-16px d-flex align-items-center justify-content-center text-light font-weight-bolder bg-dark border-dark">T</div>
													<div className="w-30px h-30px me-2 border fs-16px d-flex align-items-center justify-content-center text-light-emphasis font-weight-bolder bg-dark border-dark">T</div>
													.text-light / emphasis
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px me-1 border fs-16px d-flex align-items-center justify-content-center text-white font-weight-bolder bg-dark border-dark">T</div>
													<div className="w-30px h-30px me-2 border fs-16px d-flex align-items-center justify-content-center text-white-50 font-weight-bolder bg-dark border-dark">T</div>
												...
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px me-2 border fs-16px d-flex align-items-center justify-content-center text-body-secondary font-weight-bolder">T</div>
													.text-body-secondary
												</div>
												<div className="d-flex align-items-center mb-1">
													<div className="w-30px h-30px me-2 border fs-16px d-flex align-items-center justify-content-center text-body-tertiary font-weight-bolder">T</div>
													.text-body-tertiary
												</div>
												<div className="d-flex align-items-center mb-1">
											...
											<div className="col-lg">
												<div className="small fw-bold text-body text-opacity-50 mb-2">EXTENDED TEXT COLOR</div>
							...
							<div id="backgroundColor" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-lg mb-lg-0 mb-3">
												<div className="small fw-bold text-body text-opacity-50 mb-2">BOOTSTRAP BACKGROUND COLOR</div>
											...
											<div className="col-lg">
												<div className="small fw-bold text-body text-opacity-50 mb-2">EXTENDED BACKGROUND COLOR</div>
							...
							<div id="backgroundGradientColor" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-lg mb-lg-0 mb-3">
												<div className="small fw-bold text-body text-opacity-50 mb-2">BOOTSTRAP GRADIENT CLASS</div>
											...
											<div className="col-lg">
												<div className="small fw-bold text-body text-opacity-50 mb-2">EXTENDED GRADIENT</div>
							...
							<div id="backgroundGradientFancyColor" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-lg mb-lg-0 mb-3">
												<div className="small fw-bold text-body text-opacity-50 mb-2">FANCY GRADIENT</div>
											...
											<div className="col-lg">
												<div className="small fw-bold text-body text-opacity-50 mb-2">CUSTOM GRADIENT</div>
								...
								<Card>
									<CardBody>
										...
										<div className="ratio ratio-16x9">
											<iframe title="ratio" className="embed-responsive-item" src="https://www.youtube.com/embed/3Kf-FlECN7M?rel=0" allowfullscreen></iframe>
										</div>
									</CardBody>
									<div className="hljs-container">
							...
							<div id="objectFit" className="mb-5">
								...
								<Card>
									<CardBody>
										<img src="https://via.placeholder.com/400x400/f1f3f4/212837" width="100" height="75" className="object-fit-contain border rounded me-2" alt="" />
										<img src="https://via.placeholder.com/400x400/f1f3f4/212837" width="100" height="75" className="object-fit-cover border rounded me-2" alt="" />
										<img src="https://via.placeholder.com/400x400/f1f3f4/212837" width="100" height="75" className="object-fit-fill border rounded me-2" alt="" />
										<img src="https://via.placeholder.com/400x400/f1f3f4/212837" width="100" height="75" className="object-fit-scale border rounded me-2" alt="" />
										<img src="https://via.placeholder.com/400x400/f1f3f4/212837" width="100" height="75" className="object-fit-none border rounded" alt="" />
									</CardBody>
									<div className="hljs-container">
