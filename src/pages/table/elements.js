									...
									<CardBody>
										<div className="row mb-n3">
											<div className="col-xl-6">
												<div className="small text-body text-opacity-50 mb-3"><b>DEFAULT TABLE</b></div>
											...
											<div className="col-xl-6">
												<div className="small text-body text-opacity-50 mb-3"><b>DARK TABLE</b></div>
							...
							<div id="tableHeadOptions" className="mb-5">
								...
								<Card>
									<CardBody>
										<div className="row mb-n3">
											<div className="col-xl-6">
												<div className="small text-body text-opacity-50 mb-3"><b>DARK HEADER</b></div>
												<table className="table">
											...
											<div className="col-xl-6">
												<div className="small text-body text-opacity-50 mb-3"><b>LIGHT HEADER</b></div>
												<table className="table">
									...
									<CardBody>
										<table className="table mb-0">
											...
											<tbody>
												...
												<tr className="bg-primary text-body">
													<th scope="row">Warning</th>
													<td>Cell</td>
													<td>Cell</td>
												</tr>
												<tr className="bg-success text-body">
													<th scope="row">Info</th>
													<td>Cell</td>
													<td>Cell</td>
												</tr>
												<tr className="bg-warning text-body">
													<th scope="row">Light</th>
													<td>Cell</td>
													<td>Cell</td>
												</tr>
												<tr className="bg-danger text-body">
													<th scope="row">Dark</th>
													<td>Cell</td>
													<td>Cell</td>
												</tr>
