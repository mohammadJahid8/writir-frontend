...
function UiCard() {
  ...
  useEffect(() => {
    fetch("/assets/data/ui/card-code-1.json")
    ...
    fetch("/assets/data/ui/card-code-2.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-3.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-4.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-5.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-6.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-7.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-8.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-9.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
    ...
    fetch("/assets/data/ui/card-code-10.json")
      .then(function (response) {
        return response.text();
      })
      .then((html) => {
            ...
            <div className="col-xl-9">
              ...
              <div id="basicUsage" className="mb-5">
                ...
                <p>
                  ...
                  container with multiple variants and options. Please read the{" "}
                  <a
                      ...
                      <div className="col-xl-6">
                        <Card>
                          ...
                          <CardBody>
                            ...
                            <h6 className="card-subtitle mb-3 text-body text-opacity-50">
                              Card subtitle
                            </h6>
              ...
              <div id="fullscreen" className="mb-5">
                ...
                <p>
                  This is an extended feature from Bootstrap card. Add an
                  attribute
                  <code>data-toggle="card-expand"</code> to any link or button
                  to trigger the maximize or minimize the card element
                </p>
                <Card>
                  <div className="row">
              ...
              <div id="sizing" className="mb-5">
                ...
                <p>
                  ...
                  they’ll be 100% wide unless otherwise stated. You can change
                  this as needed with custom CSS, grid classes, grid Sass
                  mixins, or utilities.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="navigation" className="mb-5">
                ...
                <Card>
                  <CardBody>
                    <div className="row">
                      <div className="col-xl-6">
                        <div className="small text-body text-opacity-50 mb-3 fw-bold">
                          NAV TABS
                        </div>
                        <Card className="mb-3">
                          <CardHeader>
              ...
              <div id="images" className="mb-5">
                <h4>Images</h4>
                <p>
                  Cards include a few options for working with images. Choose
                  from appending “image caps” at either end of a card,
                  overlaying images with card content, or simply embedding the
                  image in a card.
                </p>
                <Card>
                  <CardBody>
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        <Card className="mb-3">
                          <CardBody className="pb-0">
                            <img
                              src="https://via.placeholder.com/600x400/c9d2e3/212837"
                              alt=""
                      ...
                      <div className="col-xl-6">
                        ...
                        <Card className="p-3 mb-3">
                          <img
                            src="https://via.placeholder.com/600x750/000000/ffffff"
                            alt=""
                            className="card-img"
                          />
              ...
              <div id="horizontal" className="mb-5">
                ...
                <p>
                  ...
                  made horizontal in a mobile-friendly and responsive way.
                </p>
                <Card>
                  <CardBody>
                    <Card className="mb-3">
                      <CardBody>
                        <div className="row gx-0 align-items-center">
                          <div className="col-md-4">
                            <img
                              src="https://via.placeholder.com/480x360/c9d2e3/212837"
                              alt=""
                    ...
                    <div className="row">
                      <div className="col-xl-6">
                        ...
                        <Card className="border-theme bg-theme bg-opacity-25 mb-3">
                          <CardHeader className="border-theme fw-bold small text-body">
                            HEADER
                          </CardHeader>
                          <CardBody>
                            <h5 className="card-title">Primary card title</h5>
                            <p className="card-text text-body text-opacity-75">
                              Some quick example text to build on the card title
                              and make up the bulk of the card's content.
                            </p>
                          </CardBody>
                      ...
                      <div className="col-xl-6">
                        ...
                        <Card className="border-theme mb-3">
                          <CardHeader className="border-theme text-theme fw-bold small">
                            HEADER
                          </CardHeader>
                          <CardBody>
                            ...
                            <p className="card-text text-theme text-opacity-75">
                              Some quick example text to build on the card title
                              and make up the bulk of the card's content.
                            </p>
                          </CardBody>
              ...
              <div id="cardGroups" className="mb-5">
                ...
                <p>
                  ...
                  <code>display: flex;</code> to achieve their uniform sizing.
                </p>
                <Card>
                  <CardBody>
                    <CardGroup>
              ...
              <div id="gridCards" className="mb-5">
                ...
                <p>
                  ...
                  <a href="/docs/5.2/layout/grid/#row-columns">
                    <code>.row-cols</code> classes
                  </a>{" "}
                  to control how many grid columns (wrapped around your cards)
                  you show per row. For example, here’s <code>.row-cols-1</code>{" "}
                  laying out the cards on one column, and{" "}
                  <code>.row-cols-md-2</code> splitting four cards to equal
                  width across multiple rows, from the medium breakpoint up.
                </p>
                <Card>
                  <CardBody>
              ...
              <div id="cardColumns" className="mb-5">
                <h4>Card columns</h4>
                <p>
                  In <code>v5</code>, cards can be organized into Masonry-like
                  columns with masonry javascript included.
                </p>
                <Card>
                  <CardBody>
                    <div
                      ...
                      <div className="col-sm-6 col-lg-4 mb-4">
                        <Card className="text-center">
                          <blockquote className="blockquote mb-0 card-body">
                            ...
                            <footer className="blockquote-footer text-body">
                              <small>
                                Someone famous in{" "}
                                <cite title="Source Title">Source Title</cite>
                              </small>
                      ...
                      <div className="col-sm-6 col-lg-4 mb-4">
                        <Card className="text-center">
                          <CardBody>
                            <h5 className="card-title">Card title</h5>
                            <p className="card-text">
                              This card has a regular title and short paragraphy
                              of text below it.
                            </p>
                            <p className="card-text">
                              <small className="text-muted">
                        ...
                        <Card>
                          <CardBody>
                            ...
                            <p className="card-text">
                              ...
                              text below. This card has some additional content
