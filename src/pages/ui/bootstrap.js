									...
									<CardBody>
										<div className="row">
											<div className="col-xl-6 mb-xl-0 mb-3">
												<div className="mb-2 small text-body text-opacity-50"><b>BASE NAV</b></div>
												...
												<div className="mb-2 small text-body text-opacity-50"><b>UNDERLINE NAV</b></div>
											...
											<div className="col-xl-6">
												<div className="mb-2 small text-body text-opacity-50"><b>VERTICAL NAV</b></div>
								...
								<Card>
									<CardBody>
										<div className="row">
											<div className="col-xl-6">
												<div className="mb-3">
													<div className="mb-2 small text-body text-opacity-50"><b>DEFAULT</b></div>
													<div className="progress">
														<div className="progress-bar" style={{width: '50%'}}>50%</div>
													</div>
												</div>
												<div className="mb-3">
													<div className="mb-2 small text-body text-opacity-50"><b>MULTIPLE BARS</b></div>
													<div className="progress">
											...
											<div className="col-xl-6">
												<div className="mb-3">
													<div className="mb-2 small text-body text-opacity-50"><b>STRIPED</b></div>
													<div className="progress">
														<div className="progress-bar progress-bar-striped" style={{width: '66%'}}>66%</div>
													</div>
												</div>
												<div className="mb-3">
													<div className="mb-2 small text-body text-opacity-50"><b>ANIMATED</b></div>
													<div className="progress">
								...
								<Card>
									<CardBody className="pb-0">
										<div className="row">
											<div className="col-xl-6">
												<div className="mb-4">
													<div className="mb-2 small text-body text-opacity-50"><b>BORDER SPINNER</b></div>
													<div className="spinner-border"></div>
												</div>
												<div className="mb-4">
													<div className="mb-2 small text-body text-opacity-50"><b>COLORS</b></div>
												...
												<div className="mb-4">
													<div className="mb-2 small text-body text-opacity-50"><b>SIZE</b></div>
											...
											<div className="col-xl-6">
												<div className="mb-4">
													<div className="mb-2 small text-body text-opacity-50"><b>GROWING SPINNER</b></div>
