...
import { Card, CardHeader, CardBody, CardExpandToggler } from './../../components/card/card.jsx';
	...
	return (
		<div className="d-flex flex-column h-100">
			...
			<Card className="flex-1 m-0 d-flex flex-column overflow-hidden">
				<CardHeader className="card-header d-flex bg-none">
					<span className="fw-bold flex-grow-1">File Manager</span>
					<CardExpandToggler>Expand</CardExpandToggler>
				</CardHeader>
						...
						<div className="file-manager-container">
							<div className="file-manager-sidebar">
								<div className="file-manager-sidebar-mobile-toggler">
									<button type="button" className="btn" data-toggle-class="file-manager-sidebar-mobile-toggled" data-toggle-target="#fileManager"><i className="far fa-lg fa-folder"></i></button>
								</div>
									...
									<div className="d-flex align-items-center">
										...
										<div className="flex-1 ps-3 small">
											...
											<div className="progress h-5px my-1">
												<div className="progress-bar progress-bar-striped bg-gray-500" style={{ width: '80%' }}></div>
											</div>
							...
							<div className="file-manager-content d-flex flex-column">
								<div className="mb-0 d-flex flex-wrap text-nowrap p-3 pb-0 border-bottom">
									<button type="button" className="btn btn-sm btn-default me-2 mb-3 px-2"><i className="fa fa-fw fa-home"></i></button>
									<button type="button" className="btn btn-sm btn-default me-2 mb-3" disabled><i className="fa fa-fw fa-arrow-turn-up ms-n1"></i>  Up One Level</button>
									...
									<button type="button" className="btn btn-sm btn-default me-2 mb-3 px-2"><i className="fa fa-fw fa-arrows-rotate"></i></button>
