...
function PagesDataManagement() {
	...
	useEffect(() => {
		...
		var options = {
			...
			buttons: [{ 
				extend: 'csv', 
				text: '<i class="fa fa-download fa-fw me-1 text-theme"></i> Export CSV',
				className: 'btn btn-default fs-13px fw-semibold py-5px pe-3',
				footer: true
			}]
		};
	...
	return (
		<div className="data-management" data-id="table">
			<table className="table table-bordered table-xs w-100 text-nowrap mb-3 bg-component" id="datatable">
				<thead>
					<tr>
