...
import PagesForgotPassword from '../pages/pages/forgot-password.js';
import PagesWorkSpace from '../pages/pages/workspace.js';
import PagesCreateWorkspace from '../pages/pages/create-workspace.js';
import ResetPassword from '../pages/pages/reset-password.js';
import PrivateRoute from './PrivateRoute.jsx';
import Folder from '../components/Folder/Folder.jsx';
import ApiKeyPage from '../pages/apikey/apikey.js';
import Search from '../components/search/Search.jsx';
import PageExploreDrive from '../pages/pages/explore-drive.js';
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'forgot-password', element: <PagesForgotPassword /> },
          { path: 'reset-password/:token', element: <ResetPassword /> },
          { path: 'workspace', element: <PagesWorkSpace /> },
          { path: 'explore-drive', element: <PageExploreDrive /> },
          {
            path: 'workspace/create-workspace',
            element: <PagesCreateWorkspace />,
          },
        ],
      },
      ...
      { path: 'reset-password/:token', element: <ResetPassword /> },
      { path: 'forgot-password', element: <PagesForgotPassword /> },
      { path: 'workspace', element: <PagesPricing /> },
      {
        path: 'workspace/create-workspace',
        element: <PagesCreateWorkspace />,
      },
